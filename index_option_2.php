        ...
        <div class="row mx-1 pb-3 w-80">
            <div class="col mx-auto">
                ...
                <div class="row px-3 align-items-center todo-item rounded">
                    <div class="col-auto col-sm-12 col-md-3 col-lg-3 col-xl-3 m-1 p-0 d-flex align-items-center">
                        <h2 class="m-0 p-0">
                    ...
                    <div class="col-auto col-sm-12 col-md-3 col-lg-3 col-xl-3 m-1 p-0 todo-actions">
